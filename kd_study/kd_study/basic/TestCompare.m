...
@property (copy, nonatomic) NSMutableString *mutableStr;
...
+ (void)testCopy {
    ...
    id obj = [[TestCompareObj1 class] superclass];
    
    obj1.mutableStr = [NSMutableString stringWithString:@"123"];
    
    [obj1.mutableStr appendString:@"456"];
